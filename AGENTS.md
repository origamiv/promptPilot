...
- Все размышления, ответы и тексты комментариев к коммитам писать строго на русском языке.
- После окончания каждой задачи обязательно делать `git commit` и `git push`.
